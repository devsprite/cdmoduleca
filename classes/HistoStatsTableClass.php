...
class HistoStatsTableClass extends ObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'CaContact' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'),
            'tauxTransfo' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'),
            ...
            'PourcCaProspect' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'),
            'caDejaInscrit' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'),
            'PourcCaFID' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'),
            'panierMoyen' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'),
            'caAvoir' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'),
            'pourCaAvoir' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'),
            'caImpaye' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'),
            'pourCaImpaye' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'),
            'totalVenteGrAbo' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'),
            'nbrVenteGrAbo' => array('type' => self::TYPE_INT, 'validate' => 'isInt'),
            'nbrVenteGrDesaAbo' => array('type' => self::TYPE_INT, 'validate' => 'isInt'),
            'pourcenDesabo' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'),
            'totalVenteGrPar' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'),
            'nbrVenteGrPar' => array('type' => self::TYPE_INT, 'validate' => 'isInt'),
            'pourVenteGrPar' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'),
